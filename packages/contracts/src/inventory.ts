...
export const productDeletePreviewSchema = z.object({
  productId: z.uuid(),
  name: z.string().trim().min(2).max(100),
  active: z.boolean(),
...
export type ProductDeletePreview = z.infer<typeof productDeletePreviewSchema>;
export type PreviewDeleteProductInput = z.infer<typeof previewDeleteProductInputSchema>;
...
export interface InventoryApi {
  ...
  previewDeleteProduct(input: PreviewDeleteProductInput): Promise<ProductDeletePreview>;
  deleteProduct(input: DeleteProductInput): Promise<InventoryProduct>;
