...
export const vouchers = sqliteTable('vouchers', {
  ...
  label: text('label').notNull(),
  linkedServicePointId: text('linked_service_point_id').references(() => servicePoints.id, {
    onDelete: 'restrict',
    onUpdate: 'cascade',
  }),
  linkedServicePointLabel: text('linked_service_point_label'),
...
export const expensePayments = sqliteTable('expense_payments', {
  ...
  amountCents: integer('amount_cents').notNull(),
  note: text('note'),
  status: text('status', { enum: ['active', 'refunded'] }).notNull(),
  createdAt: integer('created_at', { mode: 'timestamp_ms' }).notNull(),
