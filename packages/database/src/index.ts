...
import { auditStructureMigration } from './audit-structure-migration';
import { eventDeletionMigration } from './event-deletion-migration';
import { expensePaymentsMigration } from './expense-payments-migration';
...
import { voucherServicePointMigration } from './voucher-service-point-migration';
...
const migrations: readonly Migration[] = [
  ...
  voucherServicePointMigration,
  expensePaymentsMigration,
  auditStructureMigration,
  eventDeletionMigration,
];
